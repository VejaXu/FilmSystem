  ...
  <div class="upload-file">
    ...
    >
      ...
      <div class="el-upload__tip" slot="tip" v-if="showTip">
        请上传<b style="color: #f56c6c">{{ limit }}个</b>
    ...
    <div v-if="isShowJinDutiao" class="bacc">
      <div class="jindutiao">
        <el-progress :percentage="curPercentage" :width="80"></el-progress>
      </div>
    </div>
    <!-- 文件列表 -->
...
export default {
  ...
  props: {
    ...
    fileType: {
      type: Array,
      default: () => ["docx", "xlsx", "ppt", "txt", "pdf",'png', 'jpg', 'jpeg','zip','rar','jar','mp4'],
    },
    // 是否显示提示
    isShowTip: {
      type: Boolean,
  ...
  methods: {
    ...
    handleBeforeUpload(file) {
      ...
      if (this.fileType) {
        let fileExtension = "";
        //lastIndexOf 从数组后面查找第一个值
        if (file.name.lastIndexOf(".") > -1) {
          //方法将数组部分的副本返回到新的数组对象中，该方法不会改变原始数组
