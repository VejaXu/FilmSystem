...
import com.icss.framework.code.CreateImageCode;
import com.icss.project.system.domain.Code;
...
public class SysUserController extends BaseController
{
    ...
    //验证码
    @PostMapping("/code")
    public AjaxResult code()throws Exception{
        Code codes=new Code();
        //验证码图片生成
        CreateImageCode code=new CreateImageCode(130,30,4,5);
        //获取验证码
        codes.setCode(code.getCode());
        //存入session
//        session.setAttribute("codeKey",code);
        //下载图片,通过图片映射找到本地图片
        codes.setRoutes(code.writes());
        System.out.println("验证码:"+codes);
